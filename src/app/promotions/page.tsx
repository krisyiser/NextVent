...
import { Tag, Plus, Trash2, Package, Layers, Percent, DollarSign, CheckCircle2, X } from 'lucide-react';
...
export default function PromotionsPage() {
  ...
  return (
    <>
      <Sidebar activeModule="promotions" />
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px' }}>
                    ...
                    {deleteConfirmId === promo.id ? (
                        <div style={{ display: 'flex', gap: '4px' }}>
                            ...
                            <button onClick={() => handleDelete(promo.id)} className="icon-btn" style={{ color: 'var(--accent-danger)' }}><CheckCircle2 size={16} /></button>
                        </div>
                    ) : (
                    ...
                    <form onSubmit={handleSave}>
                        <div style={{ marginBottom: '16px' }}>
                            ...
                            <input 
                                ...
                                style={{ width: '100%', padding: '12px', backgroundColor: 'var(--bg-tertiary)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-md)', color: '#fff' }}
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', backgroundColor: 'var(--bg-tertiary)', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)', padding: '0 12px' }}>
                                        <input 
                                            ...
                                            style={{ width: '100%', padding: '12px 0', backgroundColor: 'transparent', border: 'none', color: '#fff' }}
                                        />
                                        <select 
                        ...
                        <button type="submit" style={{ width: '100%', padding: '16px', backgroundColor: 'var(--accent-primary)', border: 'none', borderRadius: 'var(--radius-md)', color: '#fff', fontWeight: 'bold', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
                            <CheckCircle2 size={20} /> GUARDAR PROMOCIÓN
                        </button>
                    </form>
                </div>
            </div>
