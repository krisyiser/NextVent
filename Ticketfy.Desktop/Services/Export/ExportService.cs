...
namespace Ticketfy.Services.Export;
...
public sealed class ExportService
{
    ...
    {
        var json = JsonSerializer.Serialize(data, typeof(IEnumerable<T>), Ticketfy.Desktop.Core.Helpers.TicketfyJsonContext.Default);
