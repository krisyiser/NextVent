...
public partial class InventoryViewModel : ObservableObject
{
    ...
    private async Task ScanBarcodeAsync(string barcode)
    {
        ...
        if (externalProduct != null)
        {
            ...
            OpenProductDialogWithParamsRequested?.Invoke(new Ticketfy.ViewModels.Dialogs.ProductDialogParameters 
            { 
                IsEditMode = false,
    ...
    private async Task CreateSnapshotAsync()
    {
        try
        {
            var svc = new Ticketfy.Services.Implementations.InventorySnapshotService();
    ...
    private void ViewSnapshots()
    {
        if (Avalonia.Application.Current?.ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop && desktop.MainWindow != null)
        {
            ...
            {
                DataContext = new Ticketfy.ViewModels.InventorySnapshotsViewModel()
            };
    ...
    private async Task PrintChecklistAsync()
    {
        ...
        var vm = new Ticketfy.ViewModels.Dialogs.PrintPreviewWindowViewModel("Checklist de Inventario Físico");
